...
var commandTable = command.Table{
	...
	"goal": {Kind: command.KindNone,
		Note: command.ReasonIntegrationNotWired},
	...
	"diff": {Kind: command.KindNone,
		Note: command.ReasonIntegrationNotWired},
	"fast": {Kind: command.KindNone,
		Note: command.ReasonIntegrationNotWired},
	"personality": {Kind: command.KindNone,
		Note: command.ReasonIntegrationNotWired},
	"review": {Kind: command.KindNone,
		Note: command.ReasonIntegrationNotWired},
	"fork": {Kind: command.KindNone,
		Note: command.ReasonIntegrationNotWired},
