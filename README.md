...
**Phase 1 (current):** foundation scaffold — Cobra/Viper/slog, device-token auth, WebSocket control plane, **fake** provider, empty **Grok** stub. Full Grok ACP lands in Phase 2.
